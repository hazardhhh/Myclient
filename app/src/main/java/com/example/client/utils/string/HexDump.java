...
public class HexDump {
	...
	public static String tablify(byte[] bytes) {
		return (new com.example.client.utils.string.HexDump()).new HexTablifier().format(com.example.client.utils.string.HexDump.toHex(bytes));
	}

	public static String tablify(byte[] bytes, int row) {
		return (new com.example.client.utils.string.HexDump()).new HexTablifier(row).format(com.example.client.utils.string.HexDump
				.toHex(bytes));
	}

	public static String tablify(byte[] bytes, int row, String pre) {
		return (new com.example.client.utils.string.HexDump()).new HexTablifier(row, pre).format(com.example.client.utils.string.HexDump
				.toHex(bytes));
	}

	public static String tablify(String hex, int row, String pre, String post) {
		return (new com.example.client.utils.string.HexDump()).new HexTablifier(row, pre, post).format(hex);
	}
