...
import com.example.client.common.media.picker.util.BitmapUtil;
import com.example.client.common.ui.imageview.HeadImageView;
...
public class ImageLoaderKit {
    ...
    private static final String TAG = com.example.client.utils.ImageLoaderKit.class.getSimpleName();
    ...
    private ImageLoaderConfiguration getDefaultConfig() throws IOException {
        ...
        ImageLoaderConfiguration config = new ImageLoaderConfiguration
                ...
                .imageDownloader(new BaseImageDownloader(context, 4 * 1000, 30 * 1000)) // connectTimeout (5 s), readTimeout (30 s)超时时间
                .writeDebugLogs()
                .build();
    ...
    public static void buildAvatarCache(List<String> accounts) {
        ...
        for (String account : accounts) {
            userInfo = UcstarUIKit.getUserInfoProvider().getUserInfo(account);
            if (userInfo != null) {
                asyncLoadAvatarBitmapToCache(ConfigureCache.getInstance().getAvatarUrl());
            }
        }
