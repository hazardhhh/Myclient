...
import com.example.client.widget.BezierHeaderView;


/**
 * 功能: QQ下拉刷新
 */
public class QQRefreshView extends com.example.client.widget.RefreshBaseView {
    LinearLayout ll_ok;
    LinearLayout ll_refresh;
    ImageView iv_ok;
    TextView tv_ok;
    ProgressBar pb_refresh;
    BezierHeaderView bezierView;
    ...
    protected View getRefreshHeaderView() {
        ...
        bezierView = (BezierHeaderView) refreshView.findViewById(R.id.bview);
        ...
        bezierView.setOnAnimResetListener(new BezierHeaderView.OnAnimResetListener() {
            @Override
            public void onReset() {
    ...
    @Override
    protected void doMoveUp(LayoutParams lp) {
