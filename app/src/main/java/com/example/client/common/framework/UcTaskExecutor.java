...
public class UcTaskExecutor implements Executor {
    ...
    public UcTaskExecutor(String name, Config config) {
        this(name, config, true);
    }

    public UcTaskExecutor(String name, Config config, boolean startup) {
        this.name = name;
        this.config = config;
