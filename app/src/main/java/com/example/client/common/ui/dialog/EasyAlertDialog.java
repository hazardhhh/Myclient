package com.example.client.common.ui.dialog;
...
public class EasyAlertDialog extends Dialog {
    ...
    public EasyAlertDialog(Context context, int style) {
        ...
        resourceId = com.example.client.R.layout.nim_easy_alert_dialog_default_layout;
    }

    public EasyAlertDialog(Context context) {
        this(context, com.example.client.R.style.dialog_default_style);
        resourceId = com.example.client.R.layout.nim_easy_alert_dialog_default_layout;
    }
	...
	public void addPositiveButton(CharSequence title, int color, float size,
		...
		positiveBtnTitle = TextUtils.isEmpty(title) ? context
				.getString(com.example.client.R.string.ok) : title;
	...
	public void addNegativeButton(CharSequence title, int color, float size,
		...
		negativeBtnTitle = TextUtils.isEmpty(title) ? context
				.getString(com.example.client.R.string.cancel) : title;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(resourceId);
        try {
        	ViewGroup root = (ViewGroup) findViewById(com.example.client.R.id.easy_alert_dialog_layout);
        	if (root != null) {
        	...
        	titleView = findViewById(com.example.client.R.id.easy_dialog_title_view);
        	if (titleView != null) {
        		setTitleVisible(isTitleVisible);
        	}
        	titleBtn = (ImageButton) findViewById(com.example.client.R.id.easy_dialog_title_button);
        	if (titleBtn != null) {
        		setTitleBtnVisible(isTitleBtnVisible);
        	}
            titleTV = (TextView) findViewById(com.example.client.R.id.easy_dialog_title_text_view);
            if (titleTV != null) {
                titleTV.setText(title);
            ...
            messageTV = (TextView) findViewById(com.example.client.R.id.easy_dialog_message_text_view);
            if (messageTV != null) {
                messageTV.setText(message);
            ...
            message2TV = (TextView) findViewById(com.example.client.R.id.easy_dialog_message_2);
            if(message2TV != null && !TextUtils.isEmpty(message2)) {
            	message2TV.setVisibility(View.VISIBLE);
                message2TV.setText(message2);
            }

            positiveBtn = (Button) findViewById(com.example.client.R.id.easy_dialog_positive_btn);
            ...
            if(isOnlyButton){
                positiveBtn.setBackground(context.getResources().getDrawable(R.drawable.nim_dialog_bg_middle));
            }

            negativeBtn = (Button) findViewById(com.example.client.R.id.easy_dialog_negative_btn);
            btnDivideView = findViewById(com.example.client.R.id.easy_dialog_btn_divide_view);
    ...
    public void setOnlyButton(boolean onlyButton) {
