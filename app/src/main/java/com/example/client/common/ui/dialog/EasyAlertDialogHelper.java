...
public class EasyAlertDialogHelper {
	...
	public static Map<String,EasyAlertDialog> easyAlertDialogMap=new HashMap();


	public static void cancelDialog(String SessionId){

		EasyAlertDialog easyAlertDialog=easyAlertDialogMap.get(SessionId);
		if(easyAlertDialog!=null){
			easyAlertDialog.dismiss();
			easyAlertDialogMap.remove(SessionId);
		}
