...
public class AchieveDataActivity extends BaseActivity implements View.OnClickListener{
    ...
    protected int getLayoutId() {
        return R.layout.mine_achievedata;
    }
...
//            editor.commit();
            ...
            //SharedPreferences取照片
//            SharedPreferences mSharedPre=getSharedPreferences("Image", MODE_PRIVATE);
//            String icon = mSharedPre.getString("icon", "");

            //SharePrefUtil取照片
            String icon = SharedPrefUtil.getString(mContext,"icon","");
            if(icon != "") {
    ...
    private void savePhoto(Bitmap bitmap) {
        String imagename = "achieveDataPhoto";
